...
public class DataContextTests
{
    ...
    public void DataContext_IsOneDeclared()
    {
        ...
        type.Should().HaveCount(1, "You need exactly one DbContext declared");
        type[0].Name.Should().Be("DataContext", "You need to call your DbContext class 'DataContext' not " + type[0].Name);
    }
